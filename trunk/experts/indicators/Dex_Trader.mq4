...
//========================================== Globals =========================================
  ...
  createGlobal("COMPARE_SWITCH", "0");
  createGlobal("BOUNDARY_SWITCH", "1");
  
  createGlobal("LOT", "0.3");
...
//=========================================== Init ===========================================
  ...
  initHud();
	...
	initCompare(getGlobal("COMPARE_SWITCH"));	
...
int start(){  
  ...
  startComments();
	...
	startCompare(getGlobal("COMPARE_SWITCH"));
